...
const AsideBarOr = ({ completedSections, activeSection, userData }) => {
    ...
    const sections = [
        { alias: "userinformation", name: "1. Encabezado del CV", route: "/create-csv/section/headerCV" },
        { alias: "studies", name: "2. Estudios", route: "/create-csv/section/studies" },
                            ...
                            <li className="nav-item mt-4">
                                <div className="nav-link">
                                    ...
                                    <div className="progress">
                                        <div className="progress-bar bg-navy" role="progressbar" style={{ width: `${(completedSectionAliases.length / sections.length) * 100}%` }} aria-valuenow={completedSectionAliases.length} aria-valuemin="0" aria-valuemax="100">
                                            {Math.round((completedSectionAliases.length / sections.length) * 100)}%
                                        </div>
                                    </div>
                                </div>
                            </li>
